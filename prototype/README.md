# Computer Use Verifier Kit Prototype
...
4. Fill [[Computer Use Verifier Kit/Verifier Promotion Decision Card]] before promoting the skill draft or calling the verifier reusable.

## Next iteration ideas
- Run the packet on one real desktop/browser workflow and compare at least two agent attempts.
